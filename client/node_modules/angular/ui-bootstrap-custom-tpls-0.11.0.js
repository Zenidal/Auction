        ...
        return {
            ...
            link: function (originalScope, element, attrs, modelCtrl) {
                ...
                var getMatchesAsync = function (inputValue) {
                    ...
                    $q.when(parserResult.source(originalScope, locals)).then(function (matches) {
                        ...
                        if (onCurrentRequest && hasFocus) {
                            ...
                            if (attrs.last) {
                                var last = originalScope.lastCellOption;
                                if (last && last.isActivated) {
                                    matches.push({ id: -1, label: inputValue, isLast: true, model: last });
                                }
                            }
                ...
                scope.select = function (activeIdx) {
                    ...
                    var model, item;
                    ////////
                    if (scope.matches[activeIdx].label.model && scope.matches[activeIdx].label.model.isActivated) {
                        scope.matches[activeIdx].label.model.clickFunction(scope.matches[activeIdx].label.label);
                    }
                    /////
